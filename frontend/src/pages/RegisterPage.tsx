    ...
    return (
        <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950 font-sans">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-indigo-600 dark:bg-indigo-900 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-teal-600 opacity-90 mix-blend-multiply"></div>
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?q=80&w=2069&auto=format&fit=crop')] bg-cover bg-center mix-blend-overlay"></div>
                ...
                <div className="relative z-10 flex flex-col justify-between p-12 lg:p-20 text-white w-full h-full">
                    ...
                    <div className="space-y-6 max-w-xl">
                        <h1 className="text-4xl lg:text-5xl font-bold leading-tight tracking-tight">
                            ...
                            <span className="text-teal-200">financial clarity.</span>
                        </h1>
                        <p className="text-lg text-indigo-100/90 font-medium leading-relaxed">
                            Join thousands of professionals who track, manage, and optimize their daily expenses with precision and style.
                        </p>
                    </div>
                ...
                <div className="w-full max-w-md space-y-10">
                    <div className="space-y-2 text-center lg:text-left">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 font-medium text-sm">
                            Enter your details to get started with ExpenseFlow
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                        ...
                        <div className="text-center text-sm font-medium text-slate-600 dark:text-slate-400">
                            ...
                            <Link to="/login" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 font-semibold transition-colors">
                                Sign in instead
                            </Link>
                        </div>
                    </form>
